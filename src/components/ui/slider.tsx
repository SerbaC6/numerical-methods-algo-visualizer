  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className={cn(
          // `bg-bordura`, nu `bg-muted`: pista trebuie să se vadă și pe fundal, și pe suprafață
          "bg-bordura relative grow overflow-hidden rounded-full data-[orientation=horizontal]:h-1.5 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-1.5",
        )}
      >
