...
Fundalul temei întunecate e #101320 și suprafața #242C41 — valorile randate de
amestecurile din `.dark`, un negru colorat pe hue-ul nopții și cardul cu o
treaptă peste el. Nu sunt ardezia (#2C444C): aceea stă pe hue 195, adică
...
PERECHI = [
    ...
    ("întunecat: text principal / fundal", "#EEF3FB", "#101320", 4.5),
    ("întunecat: text principal / suprafață", "#EEF3FB", "#242C41", 4.5),
    ("întunecat: text slab (cer) / fundal", "#A8C4EC", "#101320", 4.5),
    ("întunecat: text slab (cer) / suprafață", "#A8C4EC", "#242C41", 4.5),
    ("întunecat: safir ca TEXT / fundal (interzis)", "#0474C4", "#101320", 4.5),
    ("întunecat: alb pe buton safir", "#FFFFFF", "#0474C4", 4.5),
    ("întunecat: succes / fundal", "#F2F5FA", "#101320", 4.5),
    ("întunecat: atenție / fundal", "#FBBF24", "#101320", 4.5),
    ("întunecat: eroare / fundal", "#F87171", "#101320", 4.5),
    ("întunecat: pivot ca inel / suprafață", "#FF7A5C", "#242C41", 3.0),
    ("întunecat: pivot ca cifră / fundal", "#FF7A5C", "#101320", 4.5),
    ("întunecat: noapte pe umplere pivot", "#262B40", "#FF7A5C", 4.5),
    ("întunecat: ALB pe umplere pivot (interzis)", "#FFFFFF", "#FF7A5C", 4.5),
    ("întunecat: inel focus (cer) / fundal", "#A8C4EC", "#101320", 3.0),
    # Intervalul e element grafic, nu text: pragul e 3:1 (WCAG 1.4.11).
    ("întunecat: interval (portocaliu) / fundal", "#F97B06", "#101320", 3.0),
    ("întunecat: interval (portocaliu) / suprafață", "#F97B06", "#242C41", 3.0),
    # Treapta următoare spre fundal (#D96A05) trecea acum pragul, fiindcă
    # suprafața s-a închis: rezerva a crescut, deci nu mai e o greșeală de
    # păzit. Guardul s-a mutat cu două trepte mai jos, unde paranteza chiar
    # redevine invizibilă — sub 3:1 e bugul de la care s-a pornit.
    ("întunecat: interval domolit, rezervă", "#D96A05", "#242C41", 3.0),
    ("întunecat: interval prea domol (interzis)", "#A85304", "#242C41", 3.0),
    ...
    ("întunecat: text principal / bandă interval 20%", "#EEF3FB", "#4F3C35", 4.5),
    ("întunecat: pivot plin / bandă interval 20%", "#FF7A5C", "#4F3C35", 3.0),
    ...
    ("întunecat: eticheta curent / suprafață", "#6FBAF0", "#242C41", 4.5),
    ("întunecat: eticheta curent / fundal", "#6FBAF0", "#101320", 4.5),
    ("întunecat: eticheta anterior / suprafață", "#9CB4D6", "#242C41", 4.5),
    ("întunecat: eticheta anterior / fundal", "#9CB4D6", "#101320", 4.5),
    ("întunecat: eticheta interval / suprafață", "#FA983D", "#242C41", 4.5),
    ("întunecat: eticheta interval / fundal", "#FA983D", "#101320", 4.5),
    ("întunecat: eticheta funcție / suprafață", "#A8C4EC", "#242C41", 4.5),
    ("întunecat: eticheta soluție / suprafață", "#F2F5FA", "#242C41", 4.5),
    ("întunecat: eticheta soluție / fundal", "#F2F5FA", "#101320", 4.5),
    ("întunecat: eticheta pivot / suprafață", "#FF8E74", "#242C41", 4.5),
    ...
    ("întunecat: safir ca etichetă (interzis)", "#0474C4", "#242C41", 4.5),
    ("întunecat: portocaliul de desen ca etichetă (interzis)", "#F97B06", "#242C41", 4.5),
    ...
    ("întunecat: curba curentă prin valea la 16%", "#EC872B", "#39445C", 2.5),
    ("întunecat: curba curentă prin valea la 38%", "#DA975D", "#566682", 1.8),
    ...
    ("întunecat: grila podelei / suprafață", "#7A8FB0", "#242C41", 3.0),
    # Vechile valori, ținute ca teste care TREBUIE să pice.
    ("luminos: grila la 20% — invizibilă (interzis)", "#D5DADB", "#FFFFFF", 3.0),
    ("întunecat: grila la 22% — invizibilă (interzis)", "#414D67", "#242C41", 3.0),
    ...
    ("întunecat: contur de nod (funcție) / suprafață", "#A8C4EC", "#242C41", 3.0),
    ...
    ("întunecat: safir ca muchie de graf (interzis)", "#0474C4", "#242C41", 3.0),
    ...
    ("întunecat: text principal / celulă plină din clip", "#EEF3FB", "#253754", 4.5),
]
