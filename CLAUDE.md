...
Citește **[`Plan.md`](./Plan.md)** (viziunea, cele 20 de pagini și ce trebuie să conțină fiecare) și
...
- [ ] **Pagina 10 — `algoritmul-qr`**. `MatrixGrid` pentru iterațiile QR: trei matrice deodată
      (`A⁽ⁱ⁾`, `Q⁽ⁱ⁾`, `R⁽ⁱ⁾`) și subdiagonala care se stinge de la un pas la altul. Primitivă
      nouă: **rotația plană** desenată ca operație, nu doar ca rezultat.
